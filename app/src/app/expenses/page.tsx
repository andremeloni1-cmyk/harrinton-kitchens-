    ...
    <div className="px-4 pt-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          subtitle="Snap a photo of a receipt and Harrington Kitchens reads the vendor, amount and GST — then totals your BAS 1B and (with Xero) files it as spend-money."
        />
      ) : (
