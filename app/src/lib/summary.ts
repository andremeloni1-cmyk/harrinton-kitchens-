...
/** Formats the summary as a short, readable plain-text email body. */
export function formatWeeklySummary(s: WeeklySummary, currency = "AUD"): string {
  ...
  lines.push("");
  lines.push("— Harrington Kitchens");
  return lines.join("\n");
}
