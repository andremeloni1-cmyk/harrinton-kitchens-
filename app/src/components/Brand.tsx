...
/** Shows the company brand lockup (mitre mark + wordmark). The business name comes
 * from CompanySettings (via /api/branding); if the owner has uploaded a custom logo
 * image, that replaces the mark + wordmark. Falls back to the platform brand. */
export function Brand({
  ...
  // Prefer the configured company name; fall back to the platform brand. A custom
  // uploaded logo (image) wins over the wordmark.
