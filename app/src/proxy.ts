...
export const config = {
  ...
  matcher: ["/((?!login|reset|invite|enquire|offline|api/auth/login|api/auth/reset|api/auth/invite|api/enquire|api/branding|api/leads/scan|api/portal|portal|_next/static|_next/image|favicon.ico|sw.js|sw-version.js|manifest.webmanifest|icon.svg).*)"],
};
