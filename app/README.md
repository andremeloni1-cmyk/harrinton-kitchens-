...
| **Check measure** | On-site structured measure form (offline-tolerant) with **positioned power points, water, waste, gas and data**, **per-room site photos**, and **paste-in import** of dimensions from a spreadsheet or a text off site. Every measure carries a **cross-reference (`CM-1042`, room `-R2`, power point `-P1`, photo `-IMG3`)**, searchable in the Design tab's register. AI site-sheet reader; discrepancy detection that drafts a variation. |
